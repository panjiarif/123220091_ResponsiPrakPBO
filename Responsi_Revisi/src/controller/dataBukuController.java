...
public class dataBukuController {
    ...
    public void insert(){
        ...
        db.setHarga(hitungHarga(harga,rating));
        implDataBuku.insert(db);
    }
    
    public Double hitungHarga(Double harga, Double rating){
        Double hargaAkhir = harga + (harga/500) + (rating*100);
        System.out.println("Jadi harganya:"+hargaAkhir);
        return hargaAkhir;
    }
    ...
    public void update(){
        ...
        db.setRating(rating);
        Double harga = Double.parseDouble(frame.getJtHarga().getText());
        Double hargaAkhir = harga + 500.0 + (rating * 100.0);
